...
if (isset($_GET['id'])) {
    ...
    $peminjaman = editdatabarang('pengembalian', $id);
            ...
            <script language="JavaScript" type="text/javascript">
                function kornfirmasiUpdate(id) {
                    if (confirm("Apakah yakin akan merubah data user ini")) {
                        window.location.href = 'update_pengembalian.php?id=' + id;
                    }
                }
            </script>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <form action="update_pengembalian.php" method="post">
                            ...
                            <button type="submit" class="btn btn-primary" name="update" value="update">Update Pengembalian</button>
                            <a type="button" class="btn btn-primary" href="pengembalian.php" name="kembali"
