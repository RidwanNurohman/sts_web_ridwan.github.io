...
<div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form class="user" method="POST" action="formulirpinjam.php">
    ...
    <input type="submit" name="pinjam" class="btn btn-dark btn-user btn-block" href="peminjaman2.php">
    <a type="button" class="btn btn-dark btn-user btn-block" href="peminjaman2.php" name="kembali"
