      ...
      <div class="col-md-4">
        <div class="card" style="width: 18rem;">
              ...
              ?>
                ...
                <a href="barang2.php" class="btn btn-dark btn-block">Lihat data barang</a>
             </div>
        </div>
      </div>
      <div class="col-md-4">
        <div class="card" style="width: 18rem;">
              ...
              <?php
                ...
                <p class="card-text">Jumlah user yang meminjam barang </p>
                <h4><?= $user['jmlPinjam']; ?></h4>
                <a href="peminjaman2.php" class="btn btn-dark btn-block">Lihat data peminjaman</a>
             </div>
        </div>
      </div>
