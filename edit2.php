                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <form action="update_user.php" method="post">
                            ...
                            <button type="submit" class="btn btn-dark" name="update" value="update">Update User</button>
                            <a type="button" class="btn btn-dark" href="user.php" name="kembali"
